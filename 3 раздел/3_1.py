...
#
# ОсУ - моделирует отношение между признаками и метками. Такие модели служат для предсказания меток на основе обучающих данных
# маркированных. После построения модели можно использовать ее для присвоения меток новым ранее неизвестным данным
...
# - понижения размерности (поиск сжатого представления данных)
...
# (обратной связи) со средой. При этом взаимодействии система получает сигналы (функции наград), которые несут в себе информацию насколько хорошо/плохо
...
# - выборка образцов
# - на выход набор данных: обучающий и тестовый набор
# 2. Обучение
# - выбор модели
...
# Обучение с учителем: линейная регресссия
