...
for md in max_depth:
    ...
    ax[0, j].scatter(data_versicolor_A["sepal_length"], data_versicolor_B["petal_length"])
...
for md in max_depth:
    ...
    ax[1, j].scatter(data_virginica_A["sepal_length"], data_virginica_A["petal_length"])
    ax[1, j].scatter(data_versicolor_A["sepal_length"], data_versicolor_B["petal_length"])
